    ...
    class Default : View
    {
        ...
        public override void Render()
        {
            ...
            do
            {
                Console.Clear();
                Console.WriteLine();
                Console.WriteLine("\tSpráva vyučujících.");
                Console.WriteLine("\n\r\tVyberte požadovanou akci:");
                Console.WriteLine();
                Console.WriteLine("\t\t1: Výpis vyučujících");
                if (Uzivatel.Role != Role.admin)
                {
                    Console.ForegroundColor = ConsoleColor.DarkGray;
                }
                Console.WriteLine("\t\t2: Přidání vyučujícího");
            ...
            if (selectedItem == 1) Request("Vyucujici", "VypisVyucujici", null);
            if (selectedItem == 2) Request("Vyucujici", "PridejVyucujiciho", null);
