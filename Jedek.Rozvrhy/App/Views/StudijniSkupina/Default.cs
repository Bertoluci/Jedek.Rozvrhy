    ...
    class Default : View
    {
        ...
        public override void Render()
        {
            ...
            do
            {
                Console.Clear();
                Console.WriteLine();
                Console.WriteLine("\tSpráva studijních skupin.");
                Console.WriteLine("\n\r\tVyberte požadovanou akci:");
                Console.WriteLine();
                Console.WriteLine("\t\t1: Výpis studijních skupin");
                if (Uzivatel.Role != Role.admin)
                {
                    Console.ForegroundColor = ConsoleColor.DarkGray;
                }
                Console.WriteLine("\t\t2: Vytvoření studujních skupin");
            ...
            if (selectedItem == 1) Request("StudijniSkupina", "VypisStudijniSkupinyPredmetu", null);
            if (selectedItem == 2) Request("StudijniSkupina", "VytvorStudijniSkupiny", null);
