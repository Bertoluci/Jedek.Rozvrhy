    ...
    class Default : View
    {
        ...
        public override void Render()
        {
            ...
            do
            {
                Console.Clear();
                Console.WriteLine();
                Console.WriteLine("\tSpráva místností.");
                Console.WriteLine("\n\r\tVyberte požadovanou akci:");
                Console.WriteLine();
                Console.WriteLine("\t\t1: Výpis místností");
                if (Uzivatel.Role != Role.admin)
                {
                    Console.ForegroundColor = ConsoleColor.DarkGray;
                }
                Console.WriteLine("\t\t2: Přidání místnosti");
            ...
            if (selectedItem == 1) Request("Mistnost", "VypisMistnosti", null);
            if (selectedItem == 2) Request("Mistnost", "PridejMistnost", null);
